...
// Message
export type Message = {
  forwardedMessage: einrideexamplesyntaxv1Message | undefined;
  forwardedEnum: einrideexamplesyntaxv1Enum | undefined;
};

// Message
export type einrideexamplesyntaxv1Message = {
  // double
  ...
  // enum
  enum: einrideexamplesyntaxv1Enum | undefined;
  // message
  message: einrideexamplesyntaxv1Message | undefined;
  // optional double
  ...
  // optional enum
  optionalEnum?: einrideexamplesyntaxv1Enum;
  // optional message
  optionalMessage?: einrideexamplesyntaxv1Message;
  // repeated_double
  ...
  // repeated_enum
  repeatedEnum: einrideexamplesyntaxv1Enum[] | undefined;
  // repeated_message
  repeatedMessage: einrideexamplesyntaxv1Message[] | undefined;
  // map_string_string
  mapStringString: { [key: string]: string } | undefined;
  // map_string_message
  mapStringMessage: { [key: string]: einrideexamplesyntaxv1Message } | undefined;
  // oneof_string
  oneofString?: string;
  // oneof_enum
  oneofEnum?: einrideexamplesyntaxv1Enum;
  // oneof_message1
  oneofMessage1?: einrideexamplesyntaxv1Message;
  // oneof_message2
  oneofMessage2?: einrideexamplesyntaxv1Message;
  // any
...
// Enum
export type einrideexamplesyntaxv1Enum =
  // ENUM_UNSPECIFIED
  | "ENUM_UNSPECIFIED"
  // ENUM_ONE
  | "ENUM_ONE"
...
// NestedMessage
export type einrideexamplesyntaxv1MessageNestedMessage = {
  // nested_message.string
  string: string | undefined;
};

// NestedEnum
export type einrideexamplesyntaxv1MessageNestedEnum =
